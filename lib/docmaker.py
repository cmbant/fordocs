...
class HTMLDocMaker(object):
    ...
    def _generateModuleDocs(self):
        ...
        for dbmodule in dbmodules:
            ...
            template_dependencies = self._parseDependencies(module_dependencies, perspective=FileSystemHandler.FROM_MODULE_FOLDER)
            module_dbsubroutines = dbmodule.subroutines
            template_subroutines, template_functions = self._parseSubroutines(module_dbsubroutines, perspective=FileSystemHandler.FROM_MODULE_FOLDER)
    ...
    def _generateClassDocs(self):
        ...
        for dbclass in dbclasses:
            ...
            if class_module:
                ...
                class_module_doc = self._fshandler.moduleDocForName(class_module.name, perspective=FileSystemHandler.FROM_CLASS_FOLDER)
            else:
            ...
            if class_module:
                ...
                if class_file is not None:
                    ...
                    class_file_doc = self._fshandler.fileDocForPath(class_file.name, perspective=FileSystemHandler.FROM_MODULE_FOLDER)
                else:
            ...
            template_subroutines, template_functions = self._parseSubroutines(class_dbroutines, perspective=FileSystemHandler.FROM_CLASS_FOLDER)
