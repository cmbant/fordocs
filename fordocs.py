...
if __name__ == "__main__":
    generate_docs([r'c://work/dist/git/camb'],
                  r'z:\testoutfull', '*.f90', 'Fortran CAMB Documentation',
                  excludes=['sigma8.f90', 'second_PT*', 'tester*', 'Inspector*', 'forutils*', 'cosmorec*', 'hyrec*',
                            'writefits*'],
...
if __name__ == "__main__":
    ...
    parser.add_argument('source_folders', nargs='+',
    ...
    parser.add_argument('--title', default="Fortran Documentation",
    ...
    generate_docs(args.source_folders, args.output_folder, match_pattern=args.file_pattern, title=args.title,
                  defines=args.define, excludes=args.excludes, excludes_file=args.excludes_file,
